...
registerRoute("terms", () => {
    ...
    <div class="mb-3">
      <h4 class="fs-4">1. Acceptance of Terms</h4>
      <p class="text-muted">
    ...
    <div class="mb-3">
      <h4 class="fs-4">2. Use License</h4>
      <p class="text-muted">
      ...
      <ul class="list-unstyled text-muted">
        ...
        <li class="mb-2">• Use the materials for any commercial purpose</li>
        <li class="mb-2">• Attempt to decompile or reverse engineer any software</li>
        <li class="mb-2">• Remove any copyright or other proprietary notations</li>
      </ul>
    </div>

    <div class="mb-3">
      <h4 class="fs-4">3. Disclaimer</h4>
      <p class="text-muted">
    ...
    <div class="mb-3">
      <h4 class="fs-4">4. Limitations</h4>
      <p class="text-muted">
    ...
    <div class="mb-3">
      <h4 class="fs-4">5. Accuracy of Materials</h4>
      <p class="text-muted">
    ...
    <div class="mb-3">
      <h4 class="fs-4">7. Modifications</h4>
      <p class="text-muted">
    ...
    <div class="text-center mt-4">
      <button class="btn btn-outline-info" onclick="window.open('https://vulms.vu.edu.pk', '_blank')">Visit VU LMS</button>
    </div>
  `;
    return container;
});